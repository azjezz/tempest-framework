...
final class DateTimeFormatTest extends TestCase
{
    public function test_datetime_format(): void
    {
        ...
        static::assertFalse($rule->isValid('this is not a date'));
        static::assertTrue($rule->isValid('2024-02-19'));
    }
    ...
    public function test_datetime_format_with_different_format(): void
    {
        ...
        static::assertFalse($rule->isValid('2024-02-19'));
        static::assertTrue($rule->isValid('19/02/2024'));
    }
    ...
    public function test_datetime_format_message(): void
    {
        ...
        static::assertSame('Value should be a valid datetime in the format Y-m-d', $rule->message());
    }
}
