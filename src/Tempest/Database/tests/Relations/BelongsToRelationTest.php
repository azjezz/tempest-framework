...
final class BelongsToRelationTest extends TestCase
{
    public function test_inferred_belongs_to_relation(): void
    {
        ...
        static::assertCount(1, $inferredRelation);
        static::assertSame('belongs_to_parent_model.relatedModel', $inferredRelation[0]->getRelationName());
        static::assertEquals(
    ...
    public function test_attribute_with_default_belongs_to_relation(): void
    {
        ...
        static::assertSame('belongs_to_parent_model.otherRelatedModel', $namedRelation[0]->getRelationName());
        static::assertEquals(
    ...
    public function test_attribute_belongs_to_relation(): void
    {
        ...
        static::assertCount(1, $doublyNamedRelation);

        static::assertSame('belongs_to_parent_model.stillOtherRelatedModel', $doublyNamedRelation[0]->getRelationName());
        static::assertEquals(
