...
final class HasManyRelationTest extends TestCase
{
    ...
    public function test_inferred_has_many_relation(): void
    {
        ...
        static::assertSame('belongs_to_related.inferred[]', $inferredRelation[0]->getRelationName());
        static::assertEquals(
    ...
    public function test_attribute_with_defaults_has_many_relation(): void
    {
        ...
        static::assertCount(1, $relation);
        static::assertSame('belongs_to_related.attribute[]', $relation[0]->getRelationName());
        static::assertEquals(
    ...
    public function test_fully_filled_attribute_has_many_relation(): void
    {
        ...
        static::assertCount(1, $relation);
        static::assertSame('belongs_to_related.full[]', $relation[0]->getRelationName());
        static::assertEquals(
